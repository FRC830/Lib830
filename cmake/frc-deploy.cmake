...
string(REGEX REPLACE "\\\\" "/" ROBOT_EXECUTABLE ${ROBOT_EXECUTABLE})
string(REGEX REPLACE "C:" "/c" ROBOT_EXECUTABLE ${ROBOT_EXECUTABLE})
string(REGEX REPLACE "C:" "/c" WPILIB_HOME ${WPILIB_HOME})
...
set(target_mdns "roboRIO-${TEAM_NUMBER}-FRC")
